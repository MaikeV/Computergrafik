...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        chbMaterial = new QCheckBox(vbControls);
        chbMaterial->setObjectName(QString::fromUtf8("chbMaterial"));
        chbMaterial->setChecked(true);

        verticalLayout->addWidget(chbMaterial);

        chbDepth = new QCheckBox(vbControls);
        chbDepth->setObjectName(QString::fromUtf8("chbDepth"));

        verticalLayout->addWidget(chbDepth);

        groupBox = new QGroupBox(vbControls);
        groupBox->setObjectName(QString::fromUtf8("groupBox"));
        verticalLayout_6 = new QVBoxLayout(groupBox);
        verticalLayout_6->setObjectName(QString::fromUtf8("verticalLayout_6"));
        chbGauss = new QCheckBox(groupBox);
        chbGauss->setObjectName(QString::fromUtf8("chbGauss"));

        verticalLayout_6->addWidget(chbGauss);
        ...
        hsGauss = new QSlider(groupBox);
        hsGauss->setObjectName(QString::fromUtf8("hsGauss"));
        hsGauss->setMinimum(1);
        hsGauss->setMaximum(7);
        hsGauss->setSingleStep(1);
        hsGauss->setOrientation(Qt::Horizontal);

        horizontalLayout->addWidget(hsGauss);
        ...
        Rotations->setWidget(2, QFormLayout::LabelRole, labelA);
        ...
        Rotations->setWidget(2, QFormLayout::FieldRole, hsRotationA);

        labelB = new QLabel(gbRotation);
        labelB->setObjectName(QString::fromUtf8("labelB"));

        Rotations->setWidget(3, QFormLayout::LabelRole, labelB);
        ...
        Rotations->setWidget(3, QFormLayout::FieldRole, hsRotationB);

        labelC = new QLabel(gbRotation);
        labelC->setObjectName(QString::fromUtf8("labelC"));

        Rotations->setWidget(4, QFormLayout::LabelRole, labelC);
        ...
        Rotations->setWidget(4, QFormLayout::FieldRole, hsRotationC);
        ...
        QObject::connect(hsGauss, SIGNAL(valueChanged(int)), openGLWidget, SLOT(setGaussIntensity(int)));
        QObject::connect(openGLWidget, SIGNAL(gaussIntensityChanged(int)), label, SLOT(setNum(int)));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        chbMaterial->setText(QCoreApplication::translate("MainWindow", "Material", nullptr));
        chbDepth->setText(QCoreApplication::translate("MainWindow", "Depth", nullptr));
        groupBox->setTitle(QCoreApplication::translate("MainWindow", "Gaussian Blur", nullptr));
        chbGauss->setText(QCoreApplication::translate("MainWindow", "Activate", nullptr));
        label->setText(QCoreApplication::translate("MainWindow", "3", nullptr));
#if QT_CONFIG(tooltip)
        hsGauss->setToolTip(QString());
